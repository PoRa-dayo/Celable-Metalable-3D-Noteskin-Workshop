...
Or HD renders of the Mines? Or templates for making your own holds and rolls? Well you're in luck, 'cause they're all available for download individually in the [releases page](https://github.com/PoRa-dayo/Celable-Metalable-3D-Noteskin-Workshop/releases)! Have fun!

# Installation
- Download this entire workshop by clicking on the green <> Code button at the top of the page, or visit the [releases page](https://github.com/PoRa-dayo/Celable-Metalable-3D-Noteskin-Workshop/releases) to download individual folders of this workshop.
<img width="694" height="100" alt="msedge_QAZEPmSTNp" src="https://github.com/user-attachments/assets/6d8d3888-75f2-4c9d-b7b0-755268e4663b" />
...
# Customization
*You will only be changing the "metcelable-custom-3d" folder.*
...
- Keep opening the noteskin variant folders that you prefer until you eventually see the "metcelable-custom-3d" folder.
...
- If you like what you have built in the "metcelable-custom-3d" folder, feel free to duplicate the folder and rename it to whatever you want. That way you can save your custom build, and use the "metcelable-custom-3d" folder to customize a new one!


# Overview
For more than a decade there had been numerous attempts to make higher quality versions of the Cel and Metal noteskins. Most notable is the [Scalable Cel (Scalable for short) and Scalable Metal noteskins made by Peter Lawrence](https://github.com/Pete-Lawrence/Peters-Noteskins). But these are still visually different from the original Cel and Metal, and several people have been wanting for an actual HD recreation of the original thing.

It first started as a joke I had with recreating the original Cel accurately in HD scalable quality and calling it Celable, just to make things extra confusing! (If any of you dare asking what the difference between Celable and Scalable is, I will be very sad) Eventually it became this workshop as I start to find other recreations of Cel and Metal people have made over the years and attempt to recreate them all.

The variants that really caught my attention were Ionic and Crystallis, made by VirInPro. These are pretty much just the original Cel and Metal, but with a lot of Bevel & Emboss effect applied to them to make them extra shiny. Since the textures for fully scalable noteskins are just colors, obviously you can't just Bevel & Emboss these textures. But then I noticed that all Bevel did was putting a whole lot of shiny gradients to the original image, and so that's exactly what I did. The Ionic and Crystallis recreations here also reuse the original Celable and Metalable meshes, but with a whole lot of shiny gradients in their textures.
...
The Vibrant variants are split into different names based on the blend mode used. Vibrant is Normal blend mode with halved opacity, Re-Vibrant is made with Paint.NET's Recolor tool, Over-Vibrant is Overlay blend mode, and Multi-Vibrant is Multiply blend mode. In Ionic/Crystallis, except for Gold, Ice, Steel and VIP whose gradients were manually recreated from existing noteskins, Vibrant is made with special edits consisting of Overlay blend mode and/or Recolor tool, as well as changing the brightness and contrast, until the result looks nice to me personally.
...
Outside of NotITG, this noteskin also supports lifts. There are a few lift types for both Celable and Metalable, these colors should be visually distinct for whataver arrow customization you use. By default, they come with the Hollowed Spectrum versions. Here is a preview of some of the lift animations (these variants are: Hollowed Spectrum, Chrome, Hollowed Spectrum, and Redline, respectively):\
...
## Explosions
*The Bright W1 tap explosion is not used in NotITG or Etterna, and is only used in advanced timing windows in Outfox or ITGmania.*
